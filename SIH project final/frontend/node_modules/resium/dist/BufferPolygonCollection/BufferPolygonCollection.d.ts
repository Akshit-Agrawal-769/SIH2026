import { BlendOption, BoundingSphere, ComponentDatatype, HeightReference, Matrix4, BufferPolygonCollection as CesiumBufferPolygonCollection } from 'cesium';
import { ReactNode } from 'react';
import { PickCesiumProps } from '../core';
export type BufferPolygonCollectionCesiumProps = PickCesiumProps<CesiumBufferPolygonCollection, typeof cesiumProps>;
...
export type BufferPolygonCollectionProps = BufferPolygonCollectionCesiumProps & BufferPolygonCollectionConstructorProps & BufferPolygonCollectionOtherProps;
declare const cesiumProps: readonly ["show", "debugShowBoundingVolume"];
declare const BufferPolygonCollection: import('..').CesiumComponentType<CesiumBufferPolygonCollection, BufferPolygonCollectionProps>;
