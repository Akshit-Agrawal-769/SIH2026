...
files = [
    ...
    'src/components/ModelObservationModal.tsx',
    'src/components/OceanAnalyticsModal.tsx',
    'src/components/ColorbarLegend.tsx'
]
...
for f in files:
    ...
    # Let's fix text-xs font-bold text-white uppercase tracking-wider -> text-[10px] font-bold text-ocean-text-muted uppercase tracking-wider
