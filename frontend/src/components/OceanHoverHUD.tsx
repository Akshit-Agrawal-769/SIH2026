...
export const OceanHoverHUD: React.FC = () => {
  ...
  const getVariableColor = () => {
    switch (variable) {
      case 'salinity':
        return { icon: <Droplets className="w-3.5 h-3.5 text-teal-400" />, text: 'text-teal-400' };
      case 'chlorophyll':
  ...
  return (
    ...
    >
      {/* Variable & Depth Tag */}
      <div className="flex items-center justify-between text-[10px] uppercase font-bold tracking-wider text-ocean-text-secondary">
      ...
      <div className="pt-1.5 border-t border-white/10 flex flex-col gap-0.5 text-[10px] text-ocean-muted">
